...
- Spring Boot 통계(SGIS) 전국 코드 주의:
  ...
  - 관련 코드: `growailms-api/src/main/java/kr/go/growailms/statistics/dashboard/service/IndustryAnalysisService.java`, `growailms-api/src/main/java/kr/go/growailms/statistics/sgis/service/SgisCompanyCacheService.java`, `growailms-api/src/main/java/kr/go/growailms/statistics/sgis/client/SgisClient.java`
